...
#include "naoqi_bridge_msgs/action/detail/follow_path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const naoqi_bridge_msgs::action::FollowPath_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::action::FollowPath_Goal & ros_message)
{
  // Member: path
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = naoqi_bridge_msgs::action::FollowPath_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::action::FollowPath_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::action::FollowPath_Goal *>(
    untyped_ros_message);
...
{
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, action, FollowPath_Goal)() {
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_naoqi_bridge_msgs
cdr_serialize(
  const naoqi_bridge_msgs::action::FollowPath_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::action::FollowPath_Result & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = naoqi_bridge_msgs::action::FollowPath_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::action::FollowPath_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::action::FollowPath_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, action, FollowPath_Result)() {
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_naoqi_bridge_msgs
cdr_serialize(
  const naoqi_bridge_msgs::action::FollowPath_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: index
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::action::FollowPath_Feedback & ros_message)
{
  // Member: index
  cdr >> ros_message.index;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = naoqi_bridge_msgs::action::FollowPath_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::action::FollowPath_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::action::FollowPath_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, action, FollowPath_Feedback)() {
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_Feedback__handle;
}
...
// functions for naoqi_bridge_msgs::action::FollowPath_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_naoqi_bridge_msgs
cdr_serialize(
  const naoqi_bridge_msgs::action::FollowPath_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::action::FollowPath_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_FollowPath_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = naoqi_bridge_msgs::action::FollowPath_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::action::FollowPath_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::action::FollowPath_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, action, FollowPath_SendGoal_Request)() {
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_naoqi_bridge_msgs
cdr_serialize(
  const naoqi_bridge_msgs::action::FollowPath_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::action::FollowPath_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = naoqi_bridge_msgs::action::FollowPath_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::action::FollowPath_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::action::FollowPath_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, action, FollowPath_SendGoal_Response)() {
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_SendGoal_Response__handle;
}
...
{
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, action, FollowPath_SendGoal)() {
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_naoqi_bridge_msgs
cdr_serialize(
  const naoqi_bridge_msgs::action::FollowPath_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::action::FollowPath_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = naoqi_bridge_msgs::action::FollowPath_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::action::FollowPath_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::action::FollowPath_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, action, FollowPath_GetResult_Request)() {
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for naoqi_bridge_msgs::action::FollowPath_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_naoqi_bridge_msgs
cdr_serialize(
  const naoqi_bridge_msgs::action::FollowPath_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::action::FollowPath_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_FollowPath_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = naoqi_bridge_msgs::action::FollowPath_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::action::FollowPath_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::action::FollowPath_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, action, FollowPath_GetResult_Response)() {
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_GetResult_Response__handle;
}
...
{
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, action, FollowPath_GetResult)() {
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_GetResult__handle;
}
...
// functions for naoqi_bridge_msgs::action::FollowPath_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_naoqi_bridge_msgs
cdr_serialize(
  const naoqi_bridge_msgs::action::FollowPath_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::action::FollowPath_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_FollowPath_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = naoqi_bridge_msgs::action::FollowPath_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::action::FollowPath_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::action::FollowPath_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, action, FollowPath_FeedbackMessage)() {
  return &naoqi_bridge_msgs::action::typesupport_fastrtps_cpp::_FollowPath_FeedbackMessage__handle;
}
