...
#include "naoqi_bridge_msgs/srv/detail/get_string__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const naoqi_bridge_msgs::srv::GetString_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::srv::GetString_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = naoqi_bridge_msgs::srv::GetString_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::srv::GetString_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::srv::GetString_Request *>(
    untyped_ros_message);
...
{
  return &naoqi_bridge_msgs::srv::typesupport_fastrtps_cpp::_GetString_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, srv, GetString_Request)() {
  return &naoqi_bridge_msgs::srv::typesupport_fastrtps_cpp::_GetString_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_naoqi_bridge_msgs
cdr_serialize(
  const naoqi_bridge_msgs::srv::GetString_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: data
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::srv::GetString_Response & ros_message)
{
  // Member: data
  cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = naoqi_bridge_msgs::srv::GetString_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::srv::GetString_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::srv::GetString_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &naoqi_bridge_msgs::srv::typesupport_fastrtps_cpp::_GetString_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, srv, GetString_Response)() {
  return &naoqi_bridge_msgs::srv::typesupport_fastrtps_cpp::_GetString_Response__handle;
}
...
{
  return &naoqi_bridge_msgs::srv::typesupport_fastrtps_cpp::_GetString__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, srv, GetString)() {
  return &naoqi_bridge_msgs::srv::typesupport_fastrtps_cpp::_GetString__handle;
}
