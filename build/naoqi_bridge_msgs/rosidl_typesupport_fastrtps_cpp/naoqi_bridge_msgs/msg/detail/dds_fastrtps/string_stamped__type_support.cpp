...
#include "naoqi_bridge_msgs/msg/detail/string_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const naoqi_bridge_msgs::msg::StringStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::msg::StringStamped & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = naoqi_bridge_msgs::msg::StringStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::msg::StringStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::msg::StringStamped *>(
    untyped_ros_message);
...
{
  return &naoqi_bridge_msgs::msg::typesupport_fastrtps_cpp::_StringStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, msg, StringStamped)() {
  return &naoqi_bridge_msgs::msg::typesupport_fastrtps_cpp::_StringStamped__handle;
}
