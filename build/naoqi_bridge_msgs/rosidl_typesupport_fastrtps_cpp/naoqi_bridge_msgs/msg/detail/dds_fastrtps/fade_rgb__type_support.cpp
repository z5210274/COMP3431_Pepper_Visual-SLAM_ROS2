...
#include "naoqi_bridge_msgs/msg/detail/fade_rgb__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const naoqi_bridge_msgs::msg::FadeRGB & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: led_name
  cdr << ros_message.led_name;
  // Member: color
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::msg::FadeRGB & ros_message)
{
  // Member: led_name
  cdr >> ros_message.led_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = naoqi_bridge_msgs::msg::FadeRGB;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::msg::FadeRGB *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::msg::FadeRGB *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FadeRGB__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::msg::FadeRGB *>(
...
static size_t _FadeRGB__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FadeRGB(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FadeRGB__callbacks = {
...
static rosidl_message_type_support_t _FadeRGB__handle = {
...
{
  return &naoqi_bridge_msgs::msg::typesupport_fastrtps_cpp::_FadeRGB__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, msg, FadeRGB)() {
  return &naoqi_bridge_msgs::msg::typesupport_fastrtps_cpp::_FadeRGB__handle;
}
