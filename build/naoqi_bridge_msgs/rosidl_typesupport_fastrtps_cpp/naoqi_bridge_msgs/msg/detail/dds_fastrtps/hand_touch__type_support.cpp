...
#include "naoqi_bridge_msgs/msg/detail/hand_touch__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const naoqi_bridge_msgs::msg::HandTouch & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  naoqi_bridge_msgs::msg::HandTouch & ros_message)
{
  // Member: hand
  cdr >> ros_message.hand;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = naoqi_bridge_msgs::msg::HandTouch;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const naoqi_bridge_msgs::msg::HandTouch *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<naoqi_bridge_msgs::msg::HandTouch *>(
    untyped_ros_message);
...
{
  return &naoqi_bridge_msgs::msg::typesupport_fastrtps_cpp::_HandTouch__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, naoqi_bridge_msgs, msg, HandTouch)() {
  return &naoqi_bridge_msgs::msg::typesupport_fastrtps_cpp::_HandTouch__handle;
}
