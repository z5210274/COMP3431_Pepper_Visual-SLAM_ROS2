...
static const _GetBodyROI_Request_type_support_symbol_names_t _GetBodyROI_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, naoqi_bridge_msgs, srv, GetBodyROI_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, naoqi_bridge_msgs, srv, GetBodyROI_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, naoqi_bridge_msgs, srv, GetBodyROI_Request)() {
  return &::naoqi_bridge_msgs::srv::rosidl_typesupport_c::GetBodyROI_Request_message_type_support_handle;
}
...
static const _GetBodyROI_Response_type_support_symbol_names_t _GetBodyROI_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, naoqi_bridge_msgs, srv, GetBodyROI_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, naoqi_bridge_msgs, srv, GetBodyROI_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, naoqi_bridge_msgs, srv, GetBodyROI_Response)() {
  return &::naoqi_bridge_msgs::srv::rosidl_typesupport_c::GetBodyROI_Response_message_type_support_handle;
}
...
static const _GetBodyROI_type_support_symbol_names_t _GetBodyROI_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, naoqi_bridge_msgs, srv, GetBodyROI)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, naoqi_bridge_msgs, srv, GetBodyROI)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, naoqi_bridge_msgs, srv, GetBodyROI)() {
  return &::naoqi_bridge_msgs::srv::rosidl_typesupport_c::GetBodyROI_service_type_support_handle;
}
