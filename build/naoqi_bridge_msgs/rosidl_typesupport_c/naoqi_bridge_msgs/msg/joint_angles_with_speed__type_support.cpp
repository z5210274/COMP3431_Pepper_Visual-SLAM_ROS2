...
static const _JointAnglesWithSpeed_type_support_symbol_names_t _JointAnglesWithSpeed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, naoqi_bridge_msgs, msg, JointAnglesWithSpeed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, naoqi_bridge_msgs, msg, JointAnglesWithSpeed)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, naoqi_bridge_msgs, msg, JointAnglesWithSpeed)() {
  return &::naoqi_bridge_msgs::msg::rosidl_typesupport_c::JointAnglesWithSpeed_message_type_support_handle;
}
