...
static const _PoseWithConfidenceStamped_type_support_symbol_names_t _PoseWithConfidenceStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, naoqi_bridge_msgs, msg, PoseWithConfidenceStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, naoqi_bridge_msgs, msg, PoseWithConfidenceStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, naoqi_bridge_msgs, msg, PoseWithConfidenceStamped)() {
  return &::naoqi_bridge_msgs::msg::rosidl_typesupport_c::PoseWithConfidenceStamped_message_type_support_handle;
}
