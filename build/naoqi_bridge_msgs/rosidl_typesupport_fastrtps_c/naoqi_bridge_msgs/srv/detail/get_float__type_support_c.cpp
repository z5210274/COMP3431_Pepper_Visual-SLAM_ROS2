...
#include "naoqi_bridge_msgs/srv/detail/get_float__rosidl_typesupport_fastrtps_c.h"
...
using _GetFloat_Request__ros_msg_type = naoqi_bridge_msgs__srv__GetFloat_Request;
...
size_t get_serialized_size_naoqi_bridge_msgs__srv__GetFloat_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetFloat_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_naoqi_bridge_msgs__srv__GetFloat_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_naoqi_bridge_msgs
size_t max_serialized_size_naoqi_bridge_msgs__srv__GetFloat_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = naoqi_bridge_msgs__srv__GetFloat_Request;
    is_plain =
      (
...
static size_t _GetFloat_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_naoqi_bridge_msgs__srv__GetFloat_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, naoqi_bridge_msgs, srv, GetFloat_Request)() {
...
using _GetFloat_Response__ros_msg_type = naoqi_bridge_msgs__srv__GetFloat_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_naoqi_bridge_msgs
size_t get_serialized_size_naoqi_bridge_msgs__srv__GetFloat_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetFloat_Response__ros_msg_type * ros_message = static_cast<const _GetFloat_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_naoqi_bridge_msgs__srv__GetFloat_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_naoqi_bridge_msgs
size_t max_serialized_size_naoqi_bridge_msgs__srv__GetFloat_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = naoqi_bridge_msgs__srv__GetFloat_Response;
    is_plain =
      (
...
static size_t _GetFloat_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_naoqi_bridge_msgs__srv__GetFloat_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, naoqi_bridge_msgs, srv, GetFloat_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, naoqi_bridge_msgs, srv, GetFloat)() {
