...
#include "naoqi_bridge_msgs/msg/detail/memory_pair_int__rosidl_typesupport_fastrtps_c.h"
...
using _MemoryPairInt__ros_msg_type = naoqi_bridge_msgs__msg__MemoryPairInt;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MemoryPairInt__ros_msg_type * ros_message = static_cast<const _MemoryPairInt__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _MemoryPairInt__ros_msg_type * ros_message = static_cast<_MemoryPairInt__ros_msg_type *>(untyped_ros_message);
  // Field name: memory_key
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _MemoryPairInt__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_naoqi_bridge_msgs__msg__MemoryPairInt(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = naoqi_bridge_msgs__msg__MemoryPairInt;
    is_plain =
      (
...
static size_t _MemoryPairInt__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_naoqi_bridge_msgs__msg__MemoryPairInt(
...
static message_type_support_callbacks_t __callbacks_MemoryPairInt = {
...
static rosidl_message_type_support_t _MemoryPairInt__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MemoryPairInt,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, naoqi_bridge_msgs, msg, MemoryPairInt)() {
  return &_MemoryPairInt__type_support;
}
