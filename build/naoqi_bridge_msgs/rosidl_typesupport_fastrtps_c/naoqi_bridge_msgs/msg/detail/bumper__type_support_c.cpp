...
#include "naoqi_bridge_msgs/msg/detail/bumper__rosidl_typesupport_fastrtps_c.h"
...
using _Bumper__ros_msg_type = naoqi_bridge_msgs__msg__Bumper;
...
size_t get_serialized_size_naoqi_bridge_msgs__msg__Bumper(
  const void * untyped_ros_message,
...
static uint32_t _Bumper__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_naoqi_bridge_msgs__msg__Bumper(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_naoqi_bridge_msgs
size_t max_serialized_size_naoqi_bridge_msgs__msg__Bumper(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = naoqi_bridge_msgs__msg__Bumper;
    is_plain =
      (
...
static size_t _Bumper__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_naoqi_bridge_msgs__msg__Bumper(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, naoqi_bridge_msgs, msg, Bumper)() {
