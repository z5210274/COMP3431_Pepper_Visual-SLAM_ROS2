...
#include "naoqi_bridge_msgs/msg/detail/joint_angles_with_speed__rosidl_typesupport_fastrtps_c.h"
...
using _JointAnglesWithSpeed__ros_msg_type = naoqi_bridge_msgs__msg__JointAnglesWithSpeed;
...
static uint32_t _JointAnglesWithSpeed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_naoqi_bridge_msgs__msg__JointAnglesWithSpeed(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = naoqi_bridge_msgs__msg__JointAnglesWithSpeed;
    is_plain =
      (
...
static size_t _JointAnglesWithSpeed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_naoqi_bridge_msgs__msg__JointAnglesWithSpeed(
