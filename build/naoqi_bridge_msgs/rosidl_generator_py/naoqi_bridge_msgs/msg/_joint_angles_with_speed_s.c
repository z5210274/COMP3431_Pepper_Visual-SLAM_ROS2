...
bool naoqi_bridge_msgs__msg__joint_angles_with_speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("naoqi_bridge_msgs.msg._joint_angles_with_speed.JointAnglesWithSpeed", full_classname_dest, 67) == 0);
  }
  naoqi_bridge_msgs__msg__JointAnglesWithSpeed * ros_message = _ros_message;
  {  // header
...
PyObject * naoqi_bridge_msgs__msg__joint_angles_with_speed__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("naoqi_bridge_msgs.msg._joint_angles_with_speed");
