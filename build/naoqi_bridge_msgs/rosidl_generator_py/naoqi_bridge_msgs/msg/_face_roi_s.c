...
bool naoqi_bridge_msgs__msg__face_roi__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("naoqi_bridge_msgs.msg._face_roi.FaceROI", full_classname_dest, 39) == 0);
  }
  naoqi_bridge_msgs__msg__FaceROI * ros_message = _ros_message;
  {  // angle
...
{
  /* NOTE(esteve): Call constructor of FaceROI */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("naoqi_bridge_msgs.msg._face_roi");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FaceROI");
