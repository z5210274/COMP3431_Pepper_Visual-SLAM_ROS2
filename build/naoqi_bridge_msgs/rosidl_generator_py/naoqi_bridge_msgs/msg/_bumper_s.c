...
bool naoqi_bridge_msgs__msg__bumper__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("naoqi_bridge_msgs.msg._bumper.Bumper", full_classname_dest, 36) == 0);
  }
  naoqi_bridge_msgs__msg__Bumper * ros_message = _ros_message;
  {  // bumper
...
PyObject * naoqi_bridge_msgs__msg__bumper__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("naoqi_bridge_msgs.msg._bumper");
