    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'naoqi_bridge_msgs.action.JointTrajectory_Goal')
            logger.debug(
...
class JointTrajectory_Goal(metaclass=Metaclass_JointTrajectory_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.relative = kwargs.get('relative', int())
    ...
    def relative(self, value):
        if __debug__:
            assert \
                ...
                "The 'relative' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'relative' field must be an unsigned integer in [0, 255]"
...
class Metaclass_JointTrajectory_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'naoqi_bridge_msgs.action.JointTrajectory_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_JointTrajectory_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'naoqi_bridge_msgs.action.JointTrajectory_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_JointTrajectory_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from naoqi_bridge_msgs.action import JointTrajectory
...
class JointTrajectory_SendGoal_Request(metaclass=Metaclass_JointTrajectory_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'naoqi_bridge_msgs/JointTrajectory_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['naoqi_bridge_msgs', 'action'], 'JointTrajectory_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_Goal
...
class Metaclass_JointTrajectory_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'naoqi_bridge_msgs.action.JointTrajectory_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from naoqi_bridge_msgs.action import _joint_trajectory
...
class JointTrajectory_SendGoal(metaclass=Metaclass_JointTrajectory_SendGoal):
    from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_SendGoal_Request as Request
    from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_SendGoal_Response as Response
...
class JointTrajectory_GetResult_Response(metaclass=Metaclass_JointTrajectory_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'naoqi_bridge_msgs/JointTrajectory_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['naoqi_bridge_msgs', 'action'], 'JointTrajectory_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_Result
...
class Metaclass_JointTrajectory_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'naoqi_bridge_msgs.action.JointTrajectory_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class JointTrajectory_GetResult(metaclass=Metaclass_JointTrajectory_GetResult):
    from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_GetResult_Request as Request
    from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_GetResult_Response as Response
...
class Metaclass_JointTrajectory_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'naoqi_bridge_msgs.action.JointTrajectory_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class JointTrajectory_FeedbackMessage(metaclass=Metaclass_JointTrajectory_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'naoqi_bridge_msgs/JointTrajectory_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['naoqi_bridge_msgs', 'action'], 'JointTrajectory_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_Feedback
...
class Metaclass_JointTrajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'naoqi_bridge_msgs.action.JointTrajectory')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class JointTrajectory(metaclass=Metaclass_JointTrajectory):
    ...
    from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_Goal as Goal
    # The result message defined in the action definition.
    from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_Result as Result
    # The feedback message defined in the action definition.
    from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from naoqi_bridge_msgs.action._joint_trajectory import JointTrajectory_FeedbackMessage as FeedbackMessage
