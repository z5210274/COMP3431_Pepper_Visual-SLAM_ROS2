...
naoqi_bridge_msgs__msg__IntArrayStamped__init(naoqi_bridge_msgs__msg__IntArrayStamped * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    naoqi_bridge_msgs__msg__IntArrayStamped__fini(msg);
    return false;
  }
  // data
...
naoqi_bridge_msgs__msg__IntArrayStamped__create()
{
  ...
  naoqi_bridge_msgs__msg__IntArrayStamped * msg = (naoqi_bridge_msgs__msg__IntArrayStamped *)allocator.allocate(sizeof(naoqi_bridge_msgs__msg__IntArrayStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(naoqi_bridge_msgs__msg__IntArrayStamped));
  bool success = naoqi_bridge_msgs__msg__IntArrayStamped__init(msg);
  if (!success) {
...
naoqi_bridge_msgs__msg__IntArrayStamped__Sequence__init(naoqi_bridge_msgs__msg__IntArrayStamped__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  naoqi_bridge_msgs__msg__IntArrayStamped * data = NULL;

  if (size) {
    data = (naoqi_bridge_msgs__msg__IntArrayStamped *)allocator.zero_allocate(size, sizeof(naoqi_bridge_msgs__msg__IntArrayStamped), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = naoqi_bridge_msgs__msg__IntArrayStamped__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        naoqi_bridge_msgs__msg__IntArrayStamped__fini(&data[i - 1]);
      }
...
naoqi_bridge_msgs__msg__IntArrayStamped__Sequence__fini(naoqi_bridge_msgs__msg__IntArrayStamped__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      naoqi_bridge_msgs__msg__IntArrayStamped__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  naoqi_bridge_msgs__msg__IntArrayStamped__Sequence * array = (naoqi_bridge_msgs__msg__IntArrayStamped__Sequence *)allocator.allocate(sizeof(naoqi_bridge_msgs__msg__IntArrayStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = naoqi_bridge_msgs__msg__IntArrayStamped__Sequence__init(array, size);
  if (!success) {
...
naoqi_bridge_msgs__msg__IntArrayStamped__Sequence__destroy(naoqi_bridge_msgs__msg__IntArrayStamped__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    naoqi_bridge_msgs__msg__IntArrayStamped__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
naoqi_bridge_msgs__msg__IntArrayStamped__Sequence__are_equal(const naoqi_bridge_msgs__msg__IntArrayStamped__Sequence * lhs, const naoqi_bridge_msgs__msg__IntArrayStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!naoqi_bridge_msgs__msg__IntArrayStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  naoqi_bridge_msgs__msg__IntArrayStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(naoqi_bridge_msgs__msg__IntArrayStamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    naoqi_bridge_msgs__msg__IntArrayStamped * data =
      (naoqi_bridge_msgs__msg__IntArrayStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!naoqi_bridge_msgs__msg__IntArrayStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          naoqi_bridge_msgs__msg__IntArrayStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!naoqi_bridge_msgs__msg__IntArrayStamped__copy(
