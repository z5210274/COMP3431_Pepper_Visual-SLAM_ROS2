...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__init(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request * msg)
{
  ...
  // tangential_distance
  if (!std_msgs__msg__Float32__init(&msg->tangential_distance)) {
    naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__fini(msg);
    return false;
  }
  return true;
}
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__fini(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request * msg)
{
  ...
  // tangential_distance
  std_msgs__msg__Float32__fini(&msg->tangential_distance);
}
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__are_equal(const naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request * lhs, const naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request * rhs)
{
  ...
  if (!std_msgs__msg__Float32__are_equal(
      &(lhs->tangential_distance), &(rhs->tangential_distance)))
  {
    return false;
  }
  return true;
  ...
  naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request * output)
{
  ...
  if (!std_msgs__msg__Float32__copy(
      &(input->tangential_distance), &(output->tangential_distance)))
  {
    return false;
  }
  return true;
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__create()
{
  ...
  naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request * msg = (naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request *)allocator.allocate(sizeof(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request));
  bool success = naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__init(msg);
  if (!success) {
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence__init(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request * data = NULL;

  if (size) {
    data = (naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request *)allocator.zero_allocate(size, sizeof(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__fini(&data[i - 1]);
      }
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence__fini(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence * array = (naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence *)allocator.allocate(sizeof(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence__init(array, size);
  if (!success) {
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence__destroy(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence__are_equal(const naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence * lhs, const naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request * data =
      (naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!naoqi_bridge_msgs__srv__TangentialSecurityDistance_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response * msg = (naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response *)allocator.allocate(sizeof(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response));
  bool success = naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__destroy(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence__init(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response * data = NULL;

  if (size) {
    data = (naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response *)allocator.zero_allocate(size, sizeof(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence__fini(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence * array = (naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence *)allocator.allocate(sizeof(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence__destroy(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence__are_equal(const naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence * lhs, const naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response * data =
      (naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!naoqi_bridge_msgs__srv__TangentialSecurityDistance_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
