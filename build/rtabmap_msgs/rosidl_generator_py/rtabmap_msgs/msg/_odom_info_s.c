...
bool rtabmap_msgs__msg__odom_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // local_bundle_avg_inlier_distance
    PyObject * field = PyObject_GetAttrString(_pymsg, "local_bundle_avg_inlier_distance");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->local_bundle_avg_inlier_distance = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // local_bundle_max_key_frames_for_inlier
    PyObject * field = PyObject_GetAttrString(_pymsg, "local_bundle_max_key_frames_for_inlier");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->local_bundle_max_key_frames_for_inlier = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // key_frame_added
...
PyObject * rtabmap_msgs__msg__odom_info__convert_to_py(void * raw_ros_message)
{
  ...
  {  // local_bundle_avg_inlier_distance
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->local_bundle_avg_inlier_distance);
    {
      int rc = PyObject_SetAttrString(_pymessage, "local_bundle_avg_inlier_distance", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // local_bundle_max_key_frames_for_inlier
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->local_bundle_max_key_frames_for_inlier);
    {
      int rc = PyObject_SetAttrString(_pymessage, "local_bundle_max_key_frames_for_inlier", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
