...
rtabmap_msgs__msg__OdomInfo__are_equal(const rtabmap_msgs__msg__OdomInfo * lhs, const rtabmap_msgs__msg__OdomInfo * rhs)
{
  ...
  // local_bundle_avg_inlier_distance
  if (lhs->local_bundle_avg_inlier_distance != rhs->local_bundle_avg_inlier_distance) {
    return false;
  }
  // local_bundle_max_key_frames_for_inlier
  if (lhs->local_bundle_max_key_frames_for_inlier != rhs->local_bundle_max_key_frames_for_inlier) {
    return false;
  }
  // key_frame_added
  ...
  rtabmap_msgs__msg__OdomInfo * output)
{
  ...
  // local_bundle_avg_inlier_distance
  output->local_bundle_avg_inlier_distance = input->local_bundle_avg_inlier_distance;
  // local_bundle_max_key_frames_for_inlier
  output->local_bundle_max_key_frames_for_inlier = input->local_bundle_max_key_frames_for_inlier;
  // key_frame_added
