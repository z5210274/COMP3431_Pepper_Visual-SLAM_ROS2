  ...
  std::ostream & out)
{
  ...
  {
    out << "local_bundle_avg_inlier_distance: ";
    rosidl_generator_traits::value_to_yaml(msg.local_bundle_avg_inlier_distance, out);
    out << ", ";
  }

  // member: local_bundle_max_key_frames_for_inlier
  {
    out << "local_bundle_max_key_frames_for_inlier: ";
    rosidl_generator_traits::value_to_yaml(msg.local_bundle_max_key_frames_for_inlier, out);
    out << ", ";
  }
