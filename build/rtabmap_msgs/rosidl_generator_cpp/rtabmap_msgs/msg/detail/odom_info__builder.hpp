...
class Init_OdomInfo_local_bundle_max_key_frames_for_inlier
{
public:
  explicit Init_OdomInfo_local_bundle_max_key_frames_for_inlier(::rtabmap_msgs::msg::OdomInfo & msg)
  : msg_(msg)
  {}
  Init_OdomInfo_key_frame_added local_bundle_max_key_frames_for_inlier(::rtabmap_msgs::msg::OdomInfo::_local_bundle_max_key_frames_for_inlier_type arg)
  {
    msg_.local_bundle_max_key_frames_for_inlier = std::move(arg);
...
class Init_OdomInfo_local_bundle_avg_inlier_distance
{
public:
  explicit Init_OdomInfo_local_bundle_avg_inlier_distance(::rtabmap_msgs::msg::OdomInfo & msg)
  : msg_(msg)
  {}
  Init_OdomInfo_local_bundle_max_key_frames_for_inlier local_bundle_avg_inlier_distance(::rtabmap_msgs::msg::OdomInfo::_local_bundle_avg_inlier_distance_type arg)
  {
    msg_.local_bundle_avg_inlier_distance = std::move(arg);
    return Init_OdomInfo_local_bundle_max_key_frames_for_inlier(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_OdomInfo_local_bundle_avg_inlier_distance local_bundle_time(::rtabmap_msgs::msg::OdomInfo::_local_bundle_time_type arg)
  {
    msg_.local_bundle_time = std::move(arg);
    return Init_OdomInfo_local_bundle_avg_inlier_distance(msg_);
  }
