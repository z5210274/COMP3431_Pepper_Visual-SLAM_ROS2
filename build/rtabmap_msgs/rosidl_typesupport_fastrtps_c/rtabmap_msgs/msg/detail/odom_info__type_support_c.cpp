  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: local_bundle_avg_inlier_distance
  {
    cdr << ros_message->local_bundle_avg_inlier_distance;
  }

  // Field name: local_bundle_max_key_frames_for_inlier
  {
    cdr << ros_message->local_bundle_max_key_frames_for_inlier;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name local_bundle_avg_inlier_distance
  {
    size_t item_size = sizeof(ros_message->local_bundle_avg_inlier_distance);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name local_bundle_max_key_frames_for_inlier
  {
    size_t item_size = sizeof(ros_message->local_bundle_max_key_frames_for_inlier);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name key_frame_added
  ...
  size_t current_alignment)
{
  ...
  // member: local_bundle_avg_inlier_distance
  {
    size_t array_size = 1;
  ...
  // member: local_bundle_max_key_frames_for_inlier
  {
    size_t array_size = 1;
