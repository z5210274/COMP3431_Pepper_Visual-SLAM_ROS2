...
static rosidl_typesupport_introspection_c__MessageMember rtabmap_msgs__msg__OdomInfo__rosidl_typesupport_introspection_c__OdomInfo_message_member_array[47] = {
  {
    "header",  // name
  ...
  {
    "local_bundle_avg_inlier_distance",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_FLOAT,  // type
    0,  // upper bound of string
    NULL,  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs__msg__OdomInfo, local_bundle_avg_inlier_distance),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  {
    "local_bundle_max_key_frames_for_inlier",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_INT32,  // type
    0,  // upper bound of string
    NULL,  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs__msg__OdomInfo, local_bundle_max_key_frames_for_inlier),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, msg, OdomInfo)() {
  ...
  rtabmap_msgs__msg__OdomInfo__rosidl_typesupport_introspection_c__OdomInfo_message_member_array[33].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Transform)();
  rtabmap_msgs__msg__OdomInfo__rosidl_typesupport_introspection_c__OdomInfo_message_member_array[34].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Transform)();
  rtabmap_msgs__msg__OdomInfo__rosidl_typesupport_introspection_c__OdomInfo_message_member_array[35].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Transform)();
  rtabmap_msgs__msg__OdomInfo__rosidl_typesupport_introspection_c__OdomInfo_message_member_array[38].members_ =
  ...
  rtabmap_msgs__msg__OdomInfo__rosidl_typesupport_introspection_c__OdomInfo_message_member_array[44].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, msg, Point2f)();
  rtabmap_msgs__msg__OdomInfo__rosidl_typesupport_introspection_c__OdomInfo_message_member_array[45].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, msg, Point2f)();
