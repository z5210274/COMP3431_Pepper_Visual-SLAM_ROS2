...
public:
    ...
    QAction *actionOrbbecSDK_astra2;
    ...
    void setupUi(QMainWindow *mainWindow)
    {
        ...
        actionOrbbecSDK_astra2 = new QAction(mainWindow);
        actionOrbbecSDK_astra2->setObjectName(QString::fromUtf8("actionOrbbecSDK_astra2"));
        actionOrbbecSDK_astra2->setCheckable(true);
        ...
        menuOrbbec_Astra_2 = new QMenu(menuRGB_D_camera);
        menuOrbbec_Astra_2->setObjectName(QString::fromUtf8("menuOrbbec_Astra_2"));
        QIcon icon24;
        icon24.addFile(QString::fromUtf8(":/images/astra2.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuOrbbec_Astra_2->setIcon(icon24);
        menuStereo_camera = new QMenu(menuSelect_source);
        menuStereo_camera->setObjectName(QString::fromUtf8("menuStereo_camera"));
        QIcon icon25;
        icon25.addFile(QString::fromUtf8(":/images/bumblebee2.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuStereo_camera->setIcon(icon25);
        menuBumblebee2_2 = new QMenu(menuStereo_camera);
        menuBumblebee2_2->setObjectName(QString::fromUtf8("menuBumblebee2_2"));
        menuBumblebee2_2->setIcon(icon25);
        menuZed_camera = new QMenu(menuStereo_camera);
        menuZed_camera->setObjectName(QString::fromUtf8("menuZed_camera"));
        QIcon icon26;
        icon26.addFile(QString::fromUtf8(":/images/zed.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuZed_camera->setIcon(icon26);
        menuTara_Camera = new QMenu(menuStereo_camera);
        menuTara_Camera->setObjectName(QString::fromUtf8("menuTara_Camera"));
        QIcon icon27;
        icon27.addFile(QString::fromUtf8(":/images/tara.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuTara_Camera->setIcon(icon27);
        menuRealSense_T265 = new QMenu(menuStereo_camera);
        menuRealSense_T265->setObjectName(QString::fromUtf8("menuRealSense_T265"));
        QIcon icon28;
        icon28.addFile(QString::fromUtf8(":/images/t265.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuRealSense_T265->setIcon(icon28);
        menuMynt_Eye_S = new QMenu(menuStereo_camera);
        menuMynt_Eye_S->setObjectName(QString::fromUtf8("menuMynt_Eye_S"));
        QIcon icon29;
        icon29.addFile(QString::fromUtf8(":/images/mynteyes.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuMynt_Eye_S->setIcon(icon29);
        menuOAK_D = new QMenu(menuStereo_camera);
        menuOAK_D->setObjectName(QString::fromUtf8("menuOAK_D"));
        QIcon icon30;
        icon30.addFile(QString::fromUtf8(":/images/oakd.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuOAK_D->setIcon(icon30);
        menuOAK_D_Lite = new QMenu(menuStereo_camera);
        menuOAK_D_Lite->setObjectName(QString::fromUtf8("menuOAK_D_Lite"));
        QIcon icon31;
        icon31.addFile(QString::fromUtf8(":/images/oakd_lite.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuOAK_D_Lite->setIcon(icon31);
        menuOAK_D_Pro = new QMenu(menuStereo_camera);
        menuOAK_D_Pro->setObjectName(QString::fromUtf8("menuOAK_D_Pro"));
        QIcon icon32;
        icon32.addFile(QString::fromUtf8(":/images/oakdpro.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuOAK_D_Pro->setIcon(icon32);
        ...
        menuRGB_D_camera->addAction(menuOrbbec_Astra_2->menuAction());
        ...
        menuOrbbec_Astra_2->addAction(actionOrbbecSDK_astra2);
    ...
    void retranslateUi(QMainWindow *mainWindow)
    {
        ...
        actionOrbbecSDK_astra2->setText(QCoreApplication::translate("mainWindow", "Orbbec SDK", nullptr));
        ...
        menuOrbbec_Astra_2->setTitle(QCoreApplication::translate("mainWindow", "Orbbec Astra 2", nullptr));
