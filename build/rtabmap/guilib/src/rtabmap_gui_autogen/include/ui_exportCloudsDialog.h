...
public:
    ...
    QLabel *label_136;
    QLabel *label_147;
    QDoubleSpinBox *doubleSpinBox_depthEdgeFiltering;
    QLabel *label_149;
    ...
    QDoubleSpinBox *doubleSpinBox_camProjMaxDepthError;
    QLabel *label_meshingTextureSize_20;
    ...
    QLabel *label_texturingVertexColorPolicy;
    QComboBox *comboBox_texturingColorPolicy;
    ...
    void setupUi(QDialog *ExportCloudsDialog)
    {
        ...
        ExportCloudsDialog->resize(895, 869);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -654, 861, 6498));
        ...
        gridLayout->addWidget(checkBox_bilateral, 8, 1, 1, 1);
        ...
        gridLayout->addWidget(label_136, 8, 2, 1, 1);

        label_147 = new QLabel(groupBox_regenerate);
        label_147->setObjectName(QString::fromUtf8("label_147"));
        label_147->setWordWrap(true);

        gridLayout->addWidget(label_147, 7, 2, 1, 1);

        doubleSpinBox_depthEdgeFiltering = new QDoubleSpinBox(groupBox_regenerate);
        doubleSpinBox_depthEdgeFiltering->setObjectName(QString::fromUtf8("doubleSpinBox_depthEdgeFiltering"));
        doubleSpinBox_depthEdgeFiltering->setDecimals(2);
        doubleSpinBox_depthEdgeFiltering->setMaximum(100.000000000000000);
        doubleSpinBox_depthEdgeFiltering->setSingleStep(0.100000000000000);
        doubleSpinBox_depthEdgeFiltering->setValue(4.000000000000000);

        gridLayout->addWidget(doubleSpinBox_depthEdgeFiltering, 7, 1, 1, 1);

        label_149 = new QLabel(groupBox_regenerate);
        label_149->setObjectName(QString::fromUtf8("label_149"));
        label_149->setWordWrap(true);

        gridLayout->addWidget(label_149, 9, 2, 1, 1);

        spinBox_depthConfidence = new QSpinBox(groupBox_regenerate);
        spinBox_depthConfidence->setObjectName(QString::fromUtf8("spinBox_depthConfidence"));
        spinBox_depthConfidence->setMaximum(100);

        gridLayout->addWidget(spinBox_depthConfidence, 9, 1, 1, 1);
        ...
        gridLayout_20->addWidget(label_meshingTextureSize_14, 7, 2, 1, 2);
        ...
        gridLayout_20->addWidget(label_meshingTextureSize_18, 9, 2, 1, 1);
        ...
        gridLayout_20->addWidget(lineEdit_camProjMaskFilePath, 6, 1, 1, 1);
        ...
        gridLayout_20->addWidget(comboBox_camProjExportCamera, 10, 1, 1, 1);
        ...
        gridLayout_20->addWidget(checkBox_camProjRecolorPoints, 9, 1, 1, 1);
        ...
        gridLayout_20->addWidget(checkBox_camProjKeepPointsNotSeenByCameras, 8, 1, 1, 1);
        ...
        gridLayout_20->addWidget(toolButton_camProjMaskFilePath, 6, 0, 1, 1);
        ...
        gridLayout_20->addWidget(label_meshingTextureSize_16, 5, 2, 1, 2);
        ...
        gridLayout_20->addWidget(spinBox_camProjDecimation, 5, 1, 1, 1);
        ...
        gridLayout_20->addWidget(checkBox_camProjDistanceToCamPolicy, 7, 1, 1, 1);
        ...
        gridLayout_20->addWidget(label_meshingTextureSize_19, 6, 2, 1, 2);
        ...
        gridLayout_20->addWidget(label_camProjExportCamera, 10, 2, 1, 2);
        ...
        gridLayout_20->addWidget(label_meshingTextureSize_15, 8, 2, 1, 2);

        doubleSpinBox_camProjMaxDepthError = new QDoubleSpinBox(groupBox_cameraProjection);
        doubleSpinBox_camProjMaxDepthError->setObjectName(QString::fromUtf8("doubleSpinBox_camProjMaxDepthError"));
        doubleSpinBox_camProjMaxDepthError->setDecimals(2);
        doubleSpinBox_camProjMaxDepthError->setMinimum(0.000000000000000);
        doubleSpinBox_camProjMaxDepthError->setMaximum(9.990000000000000);
        doubleSpinBox_camProjMaxDepthError->setSingleStep(0.050000000000000);
        doubleSpinBox_camProjMaxDepthError->setValue(0.000000000000000);

        gridLayout_20->addWidget(doubleSpinBox_camProjMaxDepthError, 4, 1, 1, 1);

        label_meshingTextureSize_20 = new QLabel(groupBox_cameraProjection);
        label_meshingTextureSize_20->setObjectName(QString::fromUtf8("label_meshingTextureSize_20"));
        label_meshingTextureSize_20->setWordWrap(true);

        gridLayout_20->addWidget(label_meshingTextureSize_20, 4, 2, 1, 2);
        ...
        doubleSpinBox_transferColorRadius->setDecimals(3);
        ...
        gridLayout_15->addWidget(checkBox_blending, 11, 0, 1, 1);
        ...
        gridLayout_15->addWidget(label_meshingTextureSize_3, 10, 1, 1, 1);
        ...
        gridLayout_15->addWidget(label_exposureFusion, 16, 1, 1, 1);
        ...
        gridLayout_15->addWidget(label_meshingTextureSize_5, 13, 1, 1, 1);
        ...
        gridLayout_15->addWidget(label_meshingTextureSize_6, 14, 1, 1, 1);
        ...
        gridLayout_15->addWidget(comboBox_blendingDecimation, 12, 0, 1, 1);
        ...
        gridLayout_15->addWidget(spinBox_textureBrightnessContrastRatioHigh, 14, 0, 1, 1);
        ...
        gridLayout_15->addWidget(label_exposureFusion_2, 11, 1, 1, 1);
        ...
        gridLayout_15->addWidget(label_multiband, 17, 1, 1, 1);
        ...
        gridLayout_15->addWidget(checkBox_multiband, 17, 0, 1, 1);
        ...
        gridLayout_15->addWidget(checkBox_exposureFusion, 16, 0, 1, 1);
        ...
        gridLayout_15->addWidget(label_exposureFusion_3, 12, 1, 1, 1);
        ...
        gridLayout_15->addWidget(spinBox_textureBrightnessContrastRatioLow, 13, 0, 1, 1);
        ...
        gridLayout_15->addWidget(checkBox_cameraFilter, 10, 0, 1, 1);

        label_texturingVertexColorPolicy = new QLabel(groupBox_textureMapping);
        label_texturingVertexColorPolicy->setObjectName(QString::fromUtf8("label_texturingVertexColorPolicy"));
        label_texturingVertexColorPolicy->setWordWrap(true);

        gridLayout_15->addWidget(label_texturingVertexColorPolicy, 9, 1, 1, 1);

        comboBox_texturingColorPolicy = new QComboBox(groupBox_textureMapping);
        comboBox_texturingColorPolicy->addItem(QString());
        comboBox_texturingColorPolicy->addItem(QString());
        comboBox_texturingColorPolicy->addItem(QString());
        comboBox_texturingColorPolicy->setObjectName(QString::fromUtf8("comboBox_texturingColorPolicy"));

        gridLayout_15->addWidget(comboBox_texturingColorPolicy, 9, 0, 1, 1);
    ...
    void retranslateUi(QDialog *ExportCloudsDialog)
    {
        ...
        label_147->setText(QCoreApplication::translate("ExportCloudsDialog", "Depth's edge bleeding filter error (0 means disabled). Reduce depth noise around edges.", nullptr));
        doubleSpinBox_depthEdgeFiltering->setSuffix(QCoreApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_149->setText(QCoreApplication::translate("ExportCloudsDialog", "Minimum depth confidence: 0% is low confidence, 100% is high confidence. Ignored if no depth confidence images were recorded or if set to 0%.", nullptr));
        spinBox_depthConfidence->setSuffix(QCoreApplication::translate("ExportCloudsDialog", " %", nullptr));
...
"By Node ID and Camera Index: NodeID*10+CameraIndex", nullptr));
        ...
        doubleSpinBox_camProjMaxDepthError->setSuffix(QCoreApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_meshingTextureSize_20->setText(QCoreApplication::translate("ExportCloudsDialog", "For all points registered to same pixel, only those close enough to the closest point will be colored with same color (0 means only the closest point of all points registered in same pixel is colored).", nullptr));
        ...
        label_texturingVertexColorPolicy->setText(QCoreApplication::translate("ExportCloudsDialog", "Output vertex color policy.", nullptr));
        comboBox_texturingColorPolicy->setItemText(0, QCoreApplication::translate("ExportCloudsDialog", "Colorless (standard OBJ)", nullptr));
        comboBox_texturingColorPolicy->setItemText(1, QCoreApplication::translate("ExportCloudsDialog", "Keep color on textureless polygons only", nullptr));
        comboBox_texturingColorPolicy->setItemText(2, QCoreApplication::translate("ExportCloudsDialog", "Keep all color", nullptr));
